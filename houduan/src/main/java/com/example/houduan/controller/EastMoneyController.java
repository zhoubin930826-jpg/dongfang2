...
public class EastMoneyController {
    ...
    public String getIndustryBaseData() {
        ...
        return ClaudeEastMoneyApiUtil.fetchData(url);
    }
    ...
    public String getStockKlineData(@RequestParam String stockCode) {
        String url = "https://push2his.eastmoney.com/api/qt/stock/kline/get?fields1=f1,f2,f3,f4,f5,f6&fields2=f51,f52,f53,f54,f55,f56,f57,f58,f59,f60,f61&ut=1&klt=101&fqt=1&secid=1." + stockCode + "&beg=0&end=20500000";
        return ClaudeEastMoneyApiUtil.fetchData(url);
    }
